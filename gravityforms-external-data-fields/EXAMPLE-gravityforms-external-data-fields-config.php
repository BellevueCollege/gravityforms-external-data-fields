...
EOS;
    ...
    public static $sqlColumnEmployeeLastName = "LastName";
    public static $sqlColumnEmployeeEmailAddress = "WorkEmail";
    public static $sqlColumnEmployeeDaytimePhone = "WorkPhoneNumber";
